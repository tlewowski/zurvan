...
describe('zurvan throws at wrong configuration, like ', function() {
  wrongConfigurationExample(
    'negative timeSinceStartup',
    'if timeSinceStartup is a number, it has to be >= 0',
    { timeSinceStartup: -10 }
  );
  wrongConfigurationExample(
    'timeSinceStartup not a number',
